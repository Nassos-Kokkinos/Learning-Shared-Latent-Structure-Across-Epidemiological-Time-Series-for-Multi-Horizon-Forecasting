...
PAPER_MODELS = ["nbeats", "nhits", "latent_shared_v2"]
PAPER_LABELS = {
    "nbeats": "N-BEATS",
    "nhits": "N-HiTS",
...
def plot_horizon_metric(horizon_df: pd.DataFrame, metric: str, output_path: Path, title: str) -> None:
...
def main() -> None:
    ...
    long_table_path = TABLES_DIR / "final_table_horizon_results_long.csv"
    paper_table_path = TABLES_DIR / "final_table_horizon_results_paper.csv"
    fig_mae_path = FIGURES_DIR / "final_fig_horizon_mae.png"
    fig_rmse_path = FIGURES_DIR / "final_fig_horizon_rmse.png"
    ...
    plot_horizon_metric(
        ...
        title="Final Test MAE by Forecast Horizon",
    )
    ...
    plot_horizon_metric(
        ...
        title="Final Test RMSE by Forecast Horizon",
    )
    ...
    print("\n=== FINAL HORIZON RESULTS (PAPER, TEST ONLY) ===")
