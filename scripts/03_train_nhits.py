...
MODEL_CONFIG_FILE = CONFIGS_DIR / "baseline_nhits.yaml"

MODEL_OUTPUT_FILE = RESULTS_DIR / "models" / "nhits.pt"
HISTORY_OUTPUT_FILE = RESULTS_DIR / "metrics" / "nhits_train_history.csv"
METRICS_OUTPUT_FILE = RESULTS_DIR / "metrics" / "nhits_eval_metrics.csv"
