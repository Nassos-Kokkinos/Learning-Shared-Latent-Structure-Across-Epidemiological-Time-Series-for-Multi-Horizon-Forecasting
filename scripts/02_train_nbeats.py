...
MODEL_CONFIG_FILE = CONFIGS_DIR / "baseline_nbeats.yaml"

MODEL_OUTPUT_FILE = RESULTS_DIR / "models" / "nbeats.pt"
HISTORY_OUTPUT_FILE = RESULTS_DIR / "metrics" / "nbeats_train_history.csv"
METRICS_OUTPUT_FILE = RESULTS_DIR / "metrics" / "nbeats_eval_metrics.csv"
